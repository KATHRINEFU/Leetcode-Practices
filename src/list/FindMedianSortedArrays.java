...
class Solution4{
    ...
    /**
     * Based on the fact that the 2 arrays are sorted seperatedly,
     * we could try to get the submedian of the 2 arrays in each round.
     * Than compare them.
     * And the basic idea is that the left half of the array with a smaller submedian
     * can never contains the common median.
     * @param nums1
     * @param nums2
     * @return median in merged A and B
     */
